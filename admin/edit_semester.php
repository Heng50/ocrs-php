    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-64 bg-white shadow-sm border-r border-gray-200">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="semester.php" class="flex items-center px-4 py-3 text-black bg-[#FFD700] rounded-lg group">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="mb-8">
                ...
                <div class="mt-4">
                    <h1 class="text-3xl font-bold text-black mb-2">Edit Semester</h1>
                    <p class="text-gray-600">Update semester information and details.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 max-w-2xl">
                <form action="../backend/semester_controller.php" method="post" class="space-y-6">
                    <input type="hidden" name="action" value="editSemester">
                    <input type="hidden" name="semester_id" value="<?php echo htmlspecialchars($semester['semester_id']); ?>">
                    <div>
                        <label for="semester_code" class="block text-sm font-medium text-gray-700 mb-2">Semester Code</label>
                        <input type="text" 
                               id="semester_code"
                               name="semester_code" 
                               value="<?php echo htmlspecialchars($semester['semester_code']); ?>"
                    ...
                    <div>
                        ...
                        <input type="date" 
                               id="start_date"
                               name="start_date" 
                               value="<?php echo htmlspecialchars($semester['start_date']); ?>"
                               class="block w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#FFD700] focus:border-[#FFD700] transition-colors duration-200"
                               required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" 
                               id="end_date"
                               name="end_date" 
                               value="<?php echo htmlspecialchars($semester['end_date']); ?>"
                               class="block w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#FFD700] focus:border-[#FFD700] transition-colors duration-200"
                               required>
                    </div>
