    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                <form action="../backend/class_session_controller.php" method="post" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="course_id" required class="block w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#FFD700] focus:border-[#FFD700] transition-colors duration-200">
                            <option value="<?php echo htmlspecialchars($class_session['course_id']); ?>"><?php echo htmlspecialchars($class_session['course_code']); ?> - <?php echo htmlspecialchars($class_session['course_name']); ?></option>
                            <?php
                                $stmt = $pdo->prepare("SELECT * FROM courses WHERE course_id != ?");
                                $stmt->execute([$class_session['course_id']]);
                                while($row = $stmt->fetch()):
                            ?>
                                <option value="<?php echo htmlspecialchars($row['course_id']); ?>"><?php echo htmlspecialchars($row['course_code']); ?> - <?php echo htmlspecialchars($row['course_name']); ?></option>
                            <?php endwhile; ?>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="instructor_id" required class="block w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#FFD700] focus:border-[#FFD700] transition-colors duration-200">
                            <option value="<?php echo htmlspecialchars($class_session['instructor_id']); ?>"><?php echo htmlspecialchars($class_session['username']); ?></option>
                            <?php
                                $stmt = $pdo->prepare("SELECT * FROM users WHERE role = 'user' AND user_id != ?");
                                $stmt->execute([$class_session['instructor_id']]);
                                while($row = $stmt->fetch()):
                            ?>
                                <option value="<?php echo htmlspecialchars($row['user_id']); ?>"><?php echo htmlspecialchars($row['username']); ?></option>
                            <?php endwhile; ?>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="semester" value="<?php echo htmlspecialchars($class_session['semester']); ?>" required class="block w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#FFD700] focus:border-[#FFD700] transition-colors duration-200">
                    </div>
