...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-64 bg-white shadow-sm border-r border-gray-200">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="category.php" class="flex items-center px-4 py-3 text-black bg-[#FFD700] rounded-lg group">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="mb-8">
                <div class="flex items-center space-x-4">
                    <a href="category.php" class="inline-flex items-center text-gray-600 hover:text-gray-900 transition-colors duration-200">
                ...
                <div class="mt-4">
                    <h1 class="text-3xl font-bold text-black mb-2">Add New Category</h1>
                    <p class="text-gray-600">Create a new course category for the system.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 max-w-2xl">
                <form action="../backend/category_controller.php" method="post" class="space-y-6">
                    ...
                    <div class="flex space-x-4 pt-6">
                        ...
                        <a href="category.php" class="inline-flex items-center px-6 py-3 bg-gray-500 text-white rounded-lg font-medium hover:bg-gray-600 transition-colors duration-200">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
