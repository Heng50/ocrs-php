        ...
        <div class="flex-1 p-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                <div class="max-w-2xl">
                    ...
                    <p class="mt-2 text-sm text-gray-500">Type to search for available courses</p>
                </div>
            </div>
            ...
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <span class="px-2 py-1 text-xs bg-gray-100 text-gray-600 rounded-full">${item.semester}</span>
                        ${statusBadge}
                    </div>
